"""
Test script for answer cleanup functionality (no model loading)
"""
...
⚠️ Important: This information is for educational purposes only. Always consult with a qualified healthcare professional before making any medical decisions."""
        ...
        {
            "name": "Complex messy output",
            "input": """You are a medical expert assistant. Based on the following evidence from medical literature and knowledge graphs, provide a detailed, accurate answer to the medical question.
...
Answer: Metformin, a first-line medication for type 2 diabetes, commonly causes gastrointestinal side effects. Patients may experience nausea, vomiting, diarrhea, and stomach upset. <FREETEXT> </ABSTRACT> ▃

Constraints: Provide a detailed medical answer in 30-40 words without citations. < / FREETEXT > < / ABSTRACT > ▃
...
⚠️ Important: This information is for educational purposes only. Always consult with a qualified healthcare professional before making any medical decisions."""
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        prompt_indicators = ["You are a", "Based on the following", "Instructions:", "Evidence:", "Question:", "Constraints:"]
        ...
        artifacts = ["<FREETEXT>", "</FREETEXT>", "<ABSTRACT>", "</ABSTRACT>", "▃", "</s>", "You are a", "Based on the following", "Constraints:"]
